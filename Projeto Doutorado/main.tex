...
\usepackage[backend=biber,style=abnt-numeric,sorting=none,ittitles,uniquename=init,giveninits,justify,indent,sortcites=true,maxbibnames=10,minbibnames=6]{biblatex}
...
\input{sections/2_fundamentacao_teorica.tex}
\fi
\ifincluirobjetivos
\input{sections/3_objetivos.tex}
\fi
\ifincluirmetodologia
\input{sections/4_metodologia.tex}
\fi
\ifincluirresultados
\input{sections/5_resultados_discussao.tex}
\fi
\ifincluirconclusao
\input{sections/6_conclusao.tex}
\fi
