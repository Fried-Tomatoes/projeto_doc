...
\begin{itemize}
  ...
  \item Avaliar a estabilidade dinâmica dos modelos selecionados a partir da termodinâmica ab initio usando simulações de dinâmica molecular quântica, escolhendo os modelos mais promissórios para cada orientação de baixo índice de Miller;
  \item Estudar as propriedades eletrônicas das terminações por meio de cálculos de estrutura de bandas, DOS, função trabalho e carga Bader;
